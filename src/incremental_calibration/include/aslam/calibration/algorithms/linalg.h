 ...
 */
cholmod_dense *
columnScalingMatrix(cholmod_sparse *A, cholmod_common *cholmod,
...
cholmod_sparse *eigenDenseToCholmodSparseCopy(
    const Eigen::MatrixXd &in, cholmod_common *cholmod,
    double eps = std::numeric_limits<double>::epsilon());
/**
 ...
 */
double rankTol(const Eigen::VectorXd &sv,
               double eps = std::numeric_limits<double>::epsilon());
/**
 ...
 * \param[in] eps machine precision
 */
double qrTol(cholmod_sparse *A, cholmod_common *cholmod,
             double eps = std::numeric_limits<double>::epsilon());
/**
